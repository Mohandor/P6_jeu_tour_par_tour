...
$('<img src="'+player1.weapon.url+'">').addClass('col-sm-4 playerWeapon)').appendTo($('#player1InfoRow'));
...
$('<img src="'+player2.weapon.url+'">').addClass('col-sm-4 playerWeapon)').appendTo($('#player2InfoRow'));
